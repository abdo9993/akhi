(function() {
    ...
    (function() {
        function N() {
            function a() {
                if (!a.Bc) K = a.Bc = n, L = s, c.a(x, function(a) {
                    a.dc()
                })
            }
            ...
            if (m.addEventListener) "complete" == m.readyState ? a() : m.addEventListener("DOMContentLoaded", a, s);
        ...
        function l(a) {
            ...
            var b = a.persistence;
            if ("cookie" !== b && "localStorage" !== b) p.ca('Unknown persistence type "' + b + '"; falling back to "cookie"'), b = a.persistence = "cookie";
            if (b = "localStorage" === b) {
                b = n;
                try {
        ...
        var I, t, J = Array.prototype,
            ...
            m = window.document,
            u = z.userAgent,
            R = "__mps,__mpso,__mpa,__mpap,__mpu,$people_distinct_id,__alias,__cmpns,__timers".split(","),
            ...
            y = s,
            S = {
                api_host: ("https:" == m.location.protocol ? "https://" : "http://") + "api.alooma.com",
        ...
        (function() {
            ...
            c.bind =
                function(b, d) {
                    ...
                    return f = function() {
                        ...
                        var a = new ctor;
                        ctor.prototype = q;
                        var c = b.apply(a, e.concat(B.call(arguments)));
            ...
            var k = c.a = function(a, d, c) {
                if (a != q)
                    ...
                    for (e in a)
                        if (G.call(a, e) && d.call(c, a[e], e, a) === f) break
            };
            c.s = function(a) {
                a && c.Za(a) && (a = a.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;"));
                return a
            };
            c.extend = function(a) {
                ...
                if ('"' ===
                    ...
                    for (; f();) {
                        ...
                        if ("\\" === i)
                            ...
                            } else if ("string" === typeof g[i]) d += g[i];
                        else break;
                        else d += i
                    }
                k("Bad string")
        ...
        c.S = function() {
            ...
            return function(b, c, f, k) {
                b ? b.addEventListener && !k ? b.addEventListener(c, f, s) : (c = "on" + c, b[c] = a(b, f, b[c])) : p.error("No valid element provided to register_event")
            }
        }();
        c.Ac = function() {
            function a(a, c) {
                ...
                for (var b = b.split(" "), e, f = Array(m), k = 0; k < b.length; k++)
                    ...
                    switch (i) {
                        ...
                        case "^":
                            i =
                                function(a) {
                                    return 0 == a.getAttribute(o).indexOf(p)
                                };
                            break;
                        case "$":
                            i = function(a) {
                        ...
                        case "*":
                            i = function(a) {
                                return -1 < a.getAttribute(o).indexOf(p)
                            };
                            break;
                        default:
                            i = function(a) {
        ...
        c.info = {
            ...
            Pc: function(a) {
                var b = c.info.Oc(a),
                    d = {};
                if (b !== q) d.$search_engine = b, a = c.wb(a, "yahoo" != b ? "q" : "p"), a.length && (d.mp_keyword = a);
                return d
            },
            ba: function(a, b, d) {
        ...
        var p = {
            ...
            error: function() {
                if (y && !c.e(v) && v) {
                    var a = ["Alooma error:"].concat(c.ha(arguments));
                    try {
                        v.error.apply(v, a)
                    } catch (b) {
                        c.a(a, function(a) {
        ...
        w.prototype.U = function(a, b, d, e) {
            var f = this,
                k = c.Ac(a);
            if (0 == k.length) p.error("The DOM query (" + a + ") returned 0 elements");
            else return c.a(k, function(a) {
                c.S(a, this.Ib, function(a) {
                    var c = {},
                        j = f.sa(d, this),
                        k = f.Gb.c("track_links_timeout");
                    f.Ta(a, this, c);
        ...
        A.prototype.sa = function(a, b) {
            var c = A.Wc.sa.apply(this, arguments);
            if (b.href) c.url = b.href;
            return c
        };
        A.prototype.Ta = function(a, b, c) {
            c.Hb = 2 === a.which || a.metaKey || a.ctrlKey || "_blank" === b.target;
            c.href = b.href;
            c.Hb || a.preventDefault()
        };
        A.prototype.Na = function(a, b) {
            b.Hb || setTimeout(function() {
        ...
        l.prototype.bd = function(a) {
            ...
            if (!a.cookie_name && "alooma" !== a.name && (d = "mp_" + a.token + "_" + a.name, b = this.v.parse(d))) this.v.remove(d), this.v.remove(d, n), this.G(b);
        ...
        l.prototype.G = function(a, b, d) {
            return c.k(a) ? ("undefined" === typeof b && (b = "None"), this.Ua = "undefined" === typeof d ? this.tb : d, c.a(a, function(a, c) {
                if (!this.props[c] || this.props[c] === b) this.props[c] = a
            }, this), this.save(), n) : s
        };
        l.prototype.ga = function(a, b) {
            return c.k(a) ? (this.Ua = "undefined" === typeof b ? this.tb : b, c.extend(this.props, a), this.save(), n) : s
        };
        ...
        l.prototype.za = function(a) {
            this.G({
                ...
                $initial_referring_domain: c.info.Jb(a) || "$direct"
            }, "")
        };
        ...
        l.prototype.A = function(a, b) {
            var d = this.Ia(a),
                ...
                i = this.Z("$union"),
                g = this.Z("$append", []);
            "__mps" === d ? (c.extend(f, e), this.P("$add", e), this.P("$union", e)) : "__mpso" === d ? c.a(e, function(a, b) {
                b in k || (k[b] = a)
        ...
        h.prototype.Ya = function(a, b, d) {
            ...
            else if ("alooma" === d) p.error("You must initialize the main alooma object right after you include the Alooma js snippet");
        ...
        h.prototype.Ja = function(a, b, d) {
            ...
            this.Lb(c.extend({},
                S, b, {
                    name: d,
                    token: a,
                    callback_fn: ("alooma" === d ? d : "alooma." + d) + "._jsc"
                }));
            this._jsc = C();
            this.Fa = [];
            this.Ga = [];
        ...
        h.prototype.dc = function() {
            c.a(this.Fa, function(a) {
                this.La.apply(this, a)
            }, this);
            c.a(this.Ga, function(a) {
                this.o.apply(this, a)
            }, this);
            delete this.Fa;
            delete this.Ga
            ...
            if (L) this.Ga.push(arguments);
                ...
                if ("img" in b) {
                    ...
                    g.onreadystatechange = function() {
                        if (4 === g.readyState)
                            if (200 === g.status) d && (e ? d(c.ka(g.responseText)) : d(Number(g.responseText)));
                            else {
                                var a =
        ...
        h.prototype.disable = function(a) {
            "undefined" === typeof a ? this.Y.xc = n : this.Ea = this.Ea.concat(a)
        };
        h.prototype.U = function(a, b, d) {
            if (c.e(a)) p.error("No event name provided to alooma.track");
            else if (this.gb(a)) "undefined" !== typeof d && d(0);
            else {
                b = b || {};
                b.token = this.c("token");
                var e = this.persistence.Mc(a);
                c.e(e) || (b.$duration = parseFloat((((new Date).getTime() -
                    e) / 1E3).toFixed(3)));
        ...
        h.prototype.pc = function(a, b) {
            if (a === this.ta("$people_distinct_id")) return p.ca("Attempting to create alias for existing People user - aborting."), -2;
            var d =
                this;
            c.e(b) && (b = this.Q());
            if (a !== b) return this.Ka("__alias", a), this.U("$create_alias", {
                alias: a,
                distinct_id: b
            }, function() {
                d.Wa(a)
        ...
        h.prototype.Lb = function(a) {
            if (c.k(a)) c.extend(this.config, a), this.c("persistence_name") || (this.config.persistence_name = this.config.cookie_name), this.c("disable_persistence") || (this.config.disable_persistence = this.config.disable_cookie),
                this.persistence && this.persistence.Tb(this.config), y = y || this.c("debug")
        };
        ...
        h.prototype.fb = function(a) {
            if (a && !this.Y.xb && !this.c("disable_notifications")) {
                ...
                this.o(this.c("api_host") + "/decide/", {
                    ...
                    a.notifications && 0 < a.notifications.length && b.nb.call(b, a.notifications[0])
                }))
            }
        };
        ...
        o.prototype.Ab = function(a, b, d) {
            var e = {},
                f = {};
            c.k(a) ? (c.a(a, function(a, b) {
                this.$(b) || (isNaN(parseFloat(a)) ? p.error("Invalid increment value passed to alooma.people.increment - must be a number") : f[b] = a)
            }, this), d = b) : (c.e(b) && (b = 1), f[a] = b);
            e.$add = f;
            return this.o(e, d)
        };
        ...
        o.prototype.o = function(a, b) {
            ...
            var d = c.vb(a),
                ...
                d = c.W(d),
                d = c.Pa(d);
            if (!this.ib()) return this.ec(a), c.e(b) || (this.na("verbose") ? b({
                status: -1,
                error: q
            }) : b(-1)), e;
            p.log("ALOOMA PEOPLE REQUEST:");
            p.log(e);
            this.d.o(this.na("api_host") +
                "/engage/", {
                    data: d
                }, this.d.pa(b, e));
            return e
        ...
        o.prototype.ec = function(a) {
            "$set" in a ? this.d.persistence.A("$set", a) : "$set_once" in a ? this.d.persistence.A("$set_once", a) : "$add" in a ? this.d.persistence.A("$add", a) : "$append" in a ? this.d.persistence.A("$append", a) : "$union" in a ? this.d.persistence.A("$union", a) : p.error("Invalid call to _enqueue():", a)
        };
        o.prototype.gc = function(a, b, d, e, f) {
            var g = this,
                j = c.extend({},
                    this.d.persistence.O("$set")),
                i = c.extend({}, this.d.persistence.O("$set_once")),
                h = c.extend({}, this.d.persistence.O("$add")),
                m = this.d.persistence.O("$append"),
                l = c.extend({}, this.d.persistence.O("$union"));
            !c.e(j) && c.k(j) && !c.R(j) && (g.d.persistence.P("$set", j), this.set(j, function(b, d) {
                0 == b && g.d.persistence.A("$set", j);
                c.e(a) || a(b, d)
            }));
            !c.e(i) && c.k(i) && !c.R(i) && (g.d.persistence.P("$set_once", i), this.Mb(i, function(a, b) {
                0 == a && g.d.persistence.A("$set_once", i);
                c.e(e) || e(a, b)
            }));
            !c.e(h) && c.k(h) && !c.R(h) &&
                (g.d.persistence.P("$add", h), this.Ab(h, function(a, d) {
                    0 == a && g.d.persistence.A("$add", h);
                    c.e(b) || b(a, d)
                }));
            !c.e(l) && c.k(l) && !c.R(l) && (g.d.persistence.P("$union", l), this.Rb(l, function(a, b) {
                0 == a && g.d.persistence.A("$union", l);
                c.e(f) || f(a, b)
            }));
            if (!c.e(m) && c.isArray(m) && m.length) {
                for (var o = m.length - 1; 0 <= o; o--) {
                    ...
                    g.append(p, function(a, b) {
                        0 == a && g.d.persistence.A("$append", p);
                        c.e(d) || d(a, b)
                    })
                }
        ...
        g.prototype.show = function() {
            var a = this;
            this.mb();
            this.p ? (this.jc(), this.ic(), this.lc(this.cc)) : setTimeout(function() {
                a.show()
            }, 300)
        };
        g.prototype.Sa = c.m(function() {
            ...
            var a = this.Uc ? this.h("video") : this.N();
            if (this.Ub) this.mc("bg", "visible"), this.L(a,
                "exiting"), setTimeout(this.lb, g.K);
            else {
                var b, c, e;
        ...
        g.prototype.mc = c.m(function(a, b) {
            ...
            if (a.className) a.className =
                (" " + a.className + " ").replace(" " + b + " ", "").replace(/^[\s\xA0]+/, "").replace(/[\s\xA0]+$/, "")
        });
        g.prototype.ma = c.m(function(a, b, c, e) {
            ...
            for (h = 0; h < a.length; h++) {
                ...
                if (i.D !== i.i) {
                    ...
                    if (0 < m && i.D >= i.i || 0 > m && i.D <= i.i) i.D = i.i
                }
            }
            if (g) {
                for (h = 0; h < a.length; h++) i = a[h], i.q && (i.q.style[i.l] = "" + i.D + ("opacity" === i.l ? "" : "px"));
                setTimeout(function() {
                    f.ma(a,
                        b, c, e)
                }, 10)
        ...
        g.prototype.cc = c.m(function() {
            var a = this;
            if (!this.Vc && !this.hb()[this.C]) this.Vc = n, this.p.appendChild(this.fa), setTimeout(function() {
                var b = a.N();
            ...
            }, 100), c.S(a.h("cancel"), "click", function(b) {
                b.preventDefault();
                a.Sa()
            }), c.S(a.h("button") || a.h("mini-content"),
                "click",
                function(b) {
                    b.preventDefault();
                    a.T ? (a.Ma("$campaign_open", {
                        $resource_type: "video"
                    }), a.nc()) : (a.Sa(), a.ra && a.Ma("$campaign_open", {
                        $resource_type: "link"
                    }, function() {
        ...
        g.prototype.ic = function() {
            ...
            if (this.u) a = '<div id="mini"><div id="mainbox"><div id="cancel"><div id="cancel-icon"></div></div><div id="mini-content"><div id="mini-icon"><div id="mini-icon-img"></div></div><div id="body"><div id="body-text"><div>' + this.body + '</div></div></div></div></div><div id="mini-border"></div></div>';
            else {
                var a = this.ra || this.T ? "" : '<div id="button-close"></div>',
                    e = this.T ? '<div id="button-play"></div>' : "";
                this.M("ie", 7) && (e = a = "");
                a = '<div id="takeover">' + this.Ob + '<div id="mainbox"><div id="cancel"><div id="cancel-icon"></div></div><div id="content">' +
                    this.yb + '<div id="title">' + this.title + '</div><div id="body">' + this.body + '</div><div id="tagline"><a href="http://alooma.com?from=inapp" target="_blank">POWERED BY ALOOMA</a></div></div><div id="button">' + a + '<a id="button-link" href="' + this.da + '">' + this.vc + "</a>" + e + "</div></div></div>"
            }
            this.Wb ? (b = "//www.youtube.com/embed/" + this.Wb + "?wmode=transparent&showinfo=0&modestbranding=0&rel=0&autoplay=1&loop=0&vq=hd1080", this.Xb && (b += "&enablejsapi=1&html5=1&controls=0", c = '<div id="video-controls"><div id="video-progress" class="video-progress-el"><div id="video-progress-total" class="video-progress-el"></div><div id="video-elapsed" class="video-progress-el"></div></div><div id="video-time" class="video-progress-el"></div></div>')) :
                this.Vb && (b = "//player.vimeo.com/video/" + this.Vb + "?autoplay=1&title=0&byline=0&portrait=0");
            if (this.T) this.ed = '<iframe id="' + g.w + '-video-frame" width="' + this.ia + '" height="' + this.V + '"  src="' + b + '" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen="1" scrolling="no"></iframe>', c = '<div id="video-' + (this.Va ? "" : "no") + 'flip"><div id="video"><div id="video-holder"></div>' + c + "</div></div>";
            b = c + a;
            this.Va && (b = (this.u ? a : "") + '<div id="flipcontainer"><div id="flipper">' + (this.u ? c : b) + "</div></div>");
            this.fa.innerHTML = ('<div id="overlay" class="' + this.ea + '"><div id="campaignid-' + this.C + '"><div id="bgwrapper"><div id="bg"></div>' + b + "</div></div></div>").replace(/class=\"/g, 'class="' + g.w + "-").replace(/id=\"/g, 'id="' + g.w + "-")
        };
        g.prototype.jc = function() {
            ...
            this.u && (a = "none");
            var h = {};
            h["@media only screen and (max-width: " + (g.Ba + 20 - 1) + "px)"] = {
                "#overlay": {
                    display: "none"
                }
            };
            a = {
                ...
                "#mini-icon": {
                    ...
                    "background-color": this.g.aa,
                    background: "linear-gradient(135deg, " + this.g.pb + " 0%, " + this.g.aa +
                        " 100%)",
                    transition: "background-color " + f
                },
                "#mini:hover #mini-icon": {
                    "background-color": this.g.$a
                },
                "#mini:hover #mainbox": {
                    "background-color": this.g.$a
                },
                ...
                "#video": {
                    ...
                    "margin-top": "100px",
                    left: "50%",
                    "margin-left": Math.round(-this.ia /
                        2) + "px",
                    overflow: "hidden",
                    "border-radius": "5px",
                    "box-shadow": b,
            ...
            this.M("ie", 7) && c.extend(a, {
                "#mini #body": {
                    display: "inline",
                    zoom: "1",
                    border: "1px solid " + this.g.qa
                },
                "#mini #body-text": {
                    padding: "20px"
                },
            ...
            for (j in a)
                for (e = 0; e < b.length; e++)
                    if (f = b[e], f in a[j])
                        for (var i = a[j][f], l = 0; l < d.length; l++) a[j]["-" + d[l] + "-" + f] = i;
            (function(a, b) {
                function c(a) {
                    var b = "",
                        d;
        ...
        g.prototype.kc = c.m(function() {
            if (this.Aa) {
                ...
                m.createElement("div");
                a.da = a.Aa;
                var b = a.Aa.match(/(?:youtube(?:-nocookie)?\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/ ]{11})/i),
                    c = a.Aa.match(/vimeo\.com\/.*?(\d+)/i);
                if (b) {
                    if (a.T = n, a.Wb = b[1], a.Xb) window.onYouTubeIframeAPIReady = function() {
        ...
        g.prototype.jb = c.m(function() {
            ...
            if (this.C) {
                ...
                d && "hidden" !== a(d, "visibility") && "none" !== a(d, "display") && this.kb()
            }
        });
        g.prototype.kb = c.m(function(a) {
            if (!this.Eb) this.Eb = n, this.C && (this.hb()[this.C] = 1 * new Date, this.bb.save()), this.Ma("$campaign_delivery", a), this.Oa.people.append({
                $campaigns: this.C,
                $notifications: {
                    campaign_id: this.C,
                    message_id: this.Fb,
        ...
        g.prototype.lc = function(a) {
            ...
            if (0 === this.ua.length) a();
                ...
                this.M("ie", 7) && setTimeout(function() {
                    var b = n;
        ...
        g.prototype.mb = function() {
            ...
            if (this.p = m.body || m.getElementsByTagName("body")[0]) this.zc = Math.max(this.p.scrollWidth,
                m.documentElement.scrollWidth, this.p.offsetWidth, m.documentElement.offsetWidth, this.p.clientWidth, m.documentElement.clientWidth), this.yc = Math.max(this.p.scrollHeight, m.documentElement.scrollHeight, this.p.offsetHeight, m.documentElement.offsetHeight, this.p.clientHeight, m.documentElement.clientHeight);
            var c = this.B.ie,
                e = m.createElement("div").style;
            this.Ub = this.p && a("transition") && a("transform");
            this.Va = (33 <= this.B.chrome || 15 <= this.B.firefox) && this.p && a("backfaceVisibility") && a("perspective") && a("transform")
        };
        ...
        g.prototype.Ma = function(a, b, d) {
            ...
            }), this.Oa.track(a, b, d)) : d && d.call()
        };
        g.prototype.ob = c.m(function() {
            var a = this;
            if (!a.fd) {
                a.fd = n;
                var b = a.h("video-elapsed"),
                    d = a.h("video-time"),
                    e = a.h("video-progress");
        ...
        (function() {
            I = 1;
            t = window.alooma;
            c.e(t) ? p.ca("'alooma' object not initialized. Ensure you are using the latest version of the Alooma JS Library along with the snippet we provide.") :
                t.__loaded || t.config && t.persistence ? p.error("Alooma library has already been downloaded at least once.") : 1.1 > (t.__SV || 0) ? p.ca("Version mismatch; please ensure you're using the latest version of the Alooma code snippet.") : (c.a(t._i, function(a) {
